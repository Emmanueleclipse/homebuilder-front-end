    ...
    <div className="dashboard-page">
      ...
      <div className="details-container custom-container">
        <div className="feed-main-card-div my-3 px-3 pt-3 pb-4">
          <p className="fw-bold mb-3" style={{color:'#398d63'}}>{property.name}</p>
          ...
          <button onClick={()=>showDesc()} style={{display:'flex'}}> <span >Description</span> </button>
          <button className='arrow' onClick={()=>showDesc()} ><span class='material-icons' style={{display:myHeight_description<200?'block':'none'}}>keyboard_arrow_down</span>
        ...
        <div className="btn-section">
          <button onClick={()=>showImages()} style={{display:'flex'}}> <span >Images/Video</span> </button>
          <button className='arrow' onClick={()=>showImages()} ><span class='material-icons' style={{display:myHeight_images<200?'block':'none'}}>keyboard_arrow_down</span>
        ...
        <div className="btn-section">
          <button onClick={()=>showDoc()} style={{display:'flex'}}> <span >Pdf,Doc,Svg</span> </button>
          <button className='arrow' onClick={()=>showDoc()} ><span class='material-icons' style={{display:myHeight_doc<200?'block':'none'}}>keyboard_arrow_down</span>
